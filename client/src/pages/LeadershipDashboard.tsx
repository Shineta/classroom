...
export default function LeadershipDashboard() {
  ...
  const { data: overviewStats, isLoading: overviewLoading } = useQuery<OverviewStats>({
    queryKey: ["/api/leadership/overview", selectedLocation, dateRange],
  });

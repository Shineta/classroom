      ...
      <div className="max-w-4xl mx-auto p-6 print:p-0">
        ...
        <div className="print:block hidden text-center py-6 border-t">
          <p className="text-sm text-gray-600">
            This report was generated by <a href="https://horton-innovation-llc.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">Horton Tech Innovations</a>
          </p>
